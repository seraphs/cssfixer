//@line 2 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 24 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
Cu.import("resource://gre/modules/accessibility/AccessFu.jsm");
//@line 26 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 46 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
XPCOMUtils.defineLazyModuleGetter(this, "SafeBrowsing",
                                  "resource://gre/modules/SafeBrowsing.jsm");
//@line 49 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 79 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"

//@line 81 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
XPCOMUtils.defineLazyModuleGetter(this, "WebappManager",
                                  "resource://gre/modules/WebappManager.jsm");
//@line 84 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
[
  ...
  ["bootstrap", "chrome://browser/content/bootstrap.js"],
  ["cssbrowserside", "chrome://browser/content/css-browserside.js"],
...
[
//@line 112 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
  ["WebrtcUI", ["getUserMedia:request", "recording-device-events"], "chrome://browser/content/WebrtcUI.js"],
//@line 114 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 157 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
XPCOMUtils.defineLazyServiceGetter(this, "MediaManagerService",
  "@mozilla.org/mediaManagerService;1", "nsIMediaManagerService");
//@line 160 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
TracingListener.prototype =
{
    ...
    {
        // Get entire response
        if (request.URI && request.URI.path && request.URI.path.indexOf(".css") >= 0) {
          var responseSource = this.receivedData.join('');
          this.receivedData = [];
          responseSource = bootstrap.createFixupRulesFromCSSFileContent(responseSource);
          
          var storageStream = CCIN("@mozilla.org/storagestream;1", "nsIStorageStream");
          var binaryOutputStream = CCIN("@mozilla.org/binaryoutputstream;1",
                "nsIBinaryOutputStream");
          if (responseSource.length <= 8192) {
            storageStream.init(8192, responseSource.length, null);
          } else if(responseSource.length <= 16384) {
            storageStream.init(16384, responseSource.length, null);
          } else if(responseSource.length <= 32768) {
            storageStream.init(32768, responseSource.length, null);
          } else if(responseSource.length <= 65536) {
            storageStream.init(65536, responseSource.length, null);
          } else if(responseSource.length <= 131072) {
            storageStream.init(131072, responseSource.length, null);
          } else if(responseSource.length <= 262144) {
            storageStream.init(262144, responseSource.length, null);
          }else if(responseSource.length <= 524288) {
            storageStream.init(524288, responseSource.length, null);
          }else if(responseSource.length <= 1048576) {
            storageStream.init(1048576, responseSource.length, null);
          }
...
//@line 298 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
Cu.import("resource://gre/modules/XPCOMUtils.jsm");
XPCOMUtils.defineLazyServiceGetter(this, "CrashReporter",
  "@mozilla.org/xre/app-info;1", "nsICrashReporter");
//@line 302 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 413 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 422 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 457 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    // TODO: replace with Android implementation of WebappOSUtils.isLaunchable.
    Cu.import("resource://gre/modules/Webapps.jsm");
    DOMApplicationRegistry.allAppsLaunchable = true;
//@line 463 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    RemoteDebugger.init();
    Reader.init();
    ...
    Distribution.init();
    Tabs.init();
//@line 471 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    AccessFu.attach(window);
//@line 476 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 523 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    // Bug 778855 - Perf regression if we do this here. To be addressed in bug 779008.
    setTimeout(function() { SafeBrowsing.init(); }, 5000);
//@line 526 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
  },
...
//@line 843 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 1027 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 1035 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    ...
    for (let prefName of aPrefNames) {
      ...
      switch (prefName) {
        ...
        case "privacy.donottrackheader":
          ...
          prefs.push(pref);
          continue;
//@line 1247 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
        ...
        case "datareporting.crashreporter.submitEnabled":
          ...
          prefs.push(pref);
          continue;
//@line 1254 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
      }

      // Pref name translation.
      switch (prefName) {
//@line 1268 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
      }
...
//@line 1368 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
      // Crash reporter preference is in a service; set and return.
      case "datareporting.crashreporter.submitEnabled":
        CrashReporter.submitReports = json.value;
        return;
//@line 1373 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    ...
    // Pref name translation.
    switch (json.name) {
//@line 1397 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    }
  ...
  observe: function(aSubject, aTopic, aData) {
    ...
    switch (aTopic) {
      ...
      case "http-on-examine-cached-response":
        for (itemName in aData) {
          dump("data itemName = " + itemName);
        }
...
//@line 1709 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
      ...
      case "Webapps:AutoUninstall":
        ...
        break;
//@line 1743 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
  ...
  handleEvent: function(aEvent) {
    switch (aEvent.type) {
      case "DOMContentLoaded": {
        ...
        cssbrowserside.getcss;
        bootstrap.clearFixedElms();
        bootstrap.loadIntoWindow(this.browser.contentWindow);
...
//@line 5796 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
    null,
//@line 5798 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
...
//@line 7530 "/home/cewang/newfennec/gecko/mobile/android/chrome/content/browser.js"
